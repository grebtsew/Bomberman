...
public class InputAxes
{
    ...
    public static void ReadAxes()
    {
        ...
        for (int i = 0; i < axisArray.arraySize; ++i)
        {
            ...
            //object objectinspected = axis.ObjectValue();
            //if (objectinspected == null)
            //    Debug.Log("ERRO");
            //FieldInfo[] fields = objectinspected.GetType().GetFields();
            //for (int ib = 0; ib < fields.Length; ib++)
            //{
            //    Debug.Log("field: " + fields[ib].Name);
            //}
    ...
    public static object[] GetBipolarAxes()
    {
        ...
        List<InputAxes.Axis> AxesList = (List<InputAxes.Axis>)AxesListPackage[1];
