...
#if UNITY_EDITOR
    [CustomPropertyDrawer(typeof(UpperLabel))]
    public class UpperLabelDrawer : DecoratorDrawer
    {
        UpperLabel target { get { return ((UpperLabel)attribute); } }
        ...
        {
            EditorGUI.LabelField(pos, target.name, GUI.skin.label);
        }
    }
